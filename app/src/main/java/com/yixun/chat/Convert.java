        ...
        if (objectName != null) {
            switch (objectName) {
                case "RC:TxtMsg":
                    ...
                    break;
                case "RC:ImgMsg":
                    Uri uri = Utils.getFileUri(unityContext, msg.get("localPath").getAsString());
                    messageContent = ImageMessage.obtain(uri);
                    ((ImageMessage) messageContent).setThumUri(uri);
                    if (msg.has("isFull")) {
                    ...
                    break;
                case "RC:FileMsg":
                    messageContent = FileMessage.obtain(Utils.getFileUri(unityContext, msg.get("localPath").getAsString()));
                    if (msg.has("extra")) {
                ...
                case "RC:LBSMsg":
                    ...
                    break;
                case "RC:VcMsg":
                    Uri voice = Utils.getFileUri(unityContext, msg.get("localPath").getAsString());
                ...
                case "RC:CmdMsg":
                    ...
                    if (msg.has("extra")) {
                        ((CommandMessage) messageContent).setExtra(msg.get("extra").getAsString());
                    }
                    break;
            }
        }
    ...
    static JsonObject toJson(String objectName, MessageContent content) {
        ...
        switch (objectName) {
            ...
            case "RC:ImgMsg": //图片消息
            {
                ...
                msg.addProperty("localPath", local);
            ...
            case "RC:VcMsg"://语音消息
            {
                ...
                msg.addProperty("localPath", voice.getUri().toString());
            ...
            case "RC:ContactNtf"://好友通知消息
            {
                ContactNotificationMessage contactNotificationMessage = (ContactNotificationMessage) content;

                msg.addProperty("operation", contactNotificationMessage.getOperation());
                msg.addProperty("sourceUserId", contactNotificationMessage.getSourceUserId());
                msg.addProperty("targetUserId", contactNotificationMessage.getTargetUserId());
                msg.addProperty("extra", contactNotificationMessage.getExtra());

            }
            break;

            case "RC:GrpNtf"://群组通知消息
            {
                GroupNotificationMessage groupNotificationMessage = (GroupNotificationMessage) content;
                msg.addProperty("operation", groupNotificationMessage.getOperation());
                msg.addProperty("operatorUserId", groupNotificationMessage.getOperatorUserId());
                msg.addProperty("data", groupNotificationMessage.getData());
                msg.addProperty("message", groupNotificationMessage.getMessage());
                msg.addProperty("extra", groupNotificationMessage.getExtra());
            }
            break;
            case "RC:CmdMsg": //命令消息
            {
                 CommandMessage cmdMsg=(CommandMessage) content;
                 msg.addProperty("name",cmdMsg.getName());
                 msg.addProperty("data",cmdMsg.getData());
            }
            break;
