...
import static com.yixun.chat.Convert.*;
import static com.yixun.chat.Utils.*;
...
import static com.yixun.message.Message.printException;
...
public class RongCloud {
    ...
    public static void init(Context context, String appKey){
        ...
        RongIMClient.init(context.getApplicationContext(),appKey);
        ...
        RongIMClient.addOnReceiveMessageListener(new OnReceiveMessageWrapperListener() {
            ...
            public void onReceivedMessage(Message message, ReceivedProfile profile) {
                ...
                msg.addProperty("left",  profile.getLeft());
                msg.addProperty("hasPackage",profile.hasPackage());
                msg.addProperty("offline",profile.isOffline());

                sendCommCallbackMessage("OnReceiveMessageListener",msg);
    ...
    public static void connect(String token){
        RongIMClient.connect(token,new RongIMClient.ConnectCallback(){
            ...
            public void onError(ConnectionErrorCode e) {
                ...
                msg.addProperty("errorCode",e.getValue());
                sendCommCallbackMessage("connect",msg);
            }
 ...
 */
    ...
    public static void evaluateCustomService(String kefuId,
                                            ...
                                            String suggest,
                                             String dialogId,
                                             String extra){
        RongIMClient.getInstance().evaluateCustomService(kefuId,source, CustomServiceConfig.CSEvaSolveStatus.valueOf(resolvestatus),tagText,suggest,dialogId,extra);
    }
    public static void evaluateCustomService(String kefuId, int source, int solveStatus, String suggest, String dialogId){
        RongIMClient.getInstance().evaluateCustomService(kefuId,source, CustomServiceConfig.CSEvaSolveStatus.valueOf(solveStatus),suggest,dialogId);
    }
