...
import java.util.List;
 import static   com.yixun.message.Message.UnityMessage;


public class Utils {
    static Application getCurApplication(){
    ...
    static void sendCommCallbackMessage(String callback, JsonObject msg){
        ...
        Gson gson=new Gson();
       // UnityPlayer.UnitySendMessage("SdkMgr","ChatCallback",gson.toJson(data));
        UnityMessage("ChatCallback",gson.toJson(data));
    }
